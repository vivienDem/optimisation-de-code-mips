...
/* ###--------------------------------------------------------------### */
/* file		: utl_SaveNStringWithMode.c				*/
/* date		: Apr 19 2004						*/
/* version	: v200							*/
...
unsigned int  mode;
  ...
  utl_Trace ("utl_SaveNStringWithMode", UTL_FUN__IN);
  ...
  utl_Trace ("utl_SaveNStringWithMode", UTL_FUN__OUT);
